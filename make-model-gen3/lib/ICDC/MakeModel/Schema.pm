...
ICDC::MakeModel::Schema - Representation of a "Gen3" dictionary document

=head1 SYNOPSIS

 $n = ICDC::MakeModel::Schema->new('nodename');
...
L<ICDC::MakeModel::Schema> objects represent and output the actual
